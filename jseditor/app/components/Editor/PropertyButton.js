...
class PropertyButton extends React.Component {
  render() {
	...
	<ul className="nav nav-pills nav-pills2">
   	    ...
   	    <button data-alignment="section-align-left" onClick={this.props.addClassToResource} aria-label="Right Align" className="btn btn-default {rightAlignActive}" type="button"><span aria-hidden="true" className="glyphicon glyphicon-align-right"></span></button>
