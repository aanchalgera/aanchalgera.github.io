    ...
    return (
      <div className="add-more-options">
        ...
        <span className="add-options">
          ...
          <button type="button" className="btn glyphicon glyphicon-camera" onClick={this.props.openResourcePanel.bind(this,'image', this.props.dataId, '', false)} title="Add Image" ></button>
          ...
          <button type="button" className="btn glyphicon glyphicon-picture" onClick={this.props.openResourcePanel.bind(this,'image', this.props.dataId, 'gallery', false)} title="Add Gallery" ></button>
