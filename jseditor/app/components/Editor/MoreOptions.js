    ...
    return (
      <div className="add-more-options">
        ...
        <span className="add-options">
          ...
          <button type="button" className="btn glyphicon glyphicon-stats"onClick={this.props.addResource.bind(this, {type: 'chart', currentIndex: this.props.dataId})} title="Add Infogram content"></button>
