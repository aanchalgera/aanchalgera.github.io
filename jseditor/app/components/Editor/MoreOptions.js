    ...
    return (
      <div className="add-more-options">
        ...
        <span className="add-options">
          ...
          <button className="btn glyphicon glyphicon-camera" onClick={this.props.openResourcePanel.bind(this,'image', this.props.dataId, 'hidden', false)} title="Add Image" ></button>
          ...
          <button className="btn glyphicon glyphicon-picture" onClick={this.props.openResourcePanel.bind(this,'image', this.props.dataId, 'checkbox', false)} title="Add Gallery" ></button>
