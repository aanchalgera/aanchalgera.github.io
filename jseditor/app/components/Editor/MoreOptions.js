    ...
    return (
      <div className="add-more-options">
        ...
        <span className="add-options">
          ...
          <button className="btn" onClick={this.props.groupSections.bind(this, this.props.dataId, 2)} title="2 Columns"> 2 Columns</button>
          <button className="btn" onClick={this.props.groupSections.bind(this, this.props.dataId, 3)} title="3 Columns"> 3 Columns</button>
        </span>
