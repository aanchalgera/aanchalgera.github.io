...
class MoreOptions extends React.Component {
  render() {
    ...
    const textButton = <button type="button" className="btn glyphicon glyphicon-text" onClick={() => this.props.addTextArea(this.props.dataId, 'content')} title="Add new section">T</button>;
    ...
    const summaryButton = <button type="button" className="btn glyphicon glyphicon-file" onClick={() => this.props.addTextArea(this.props.dataId, 'summary')} title="Add Summary"></button>;
    ...
    const richContentButton = <button type="button" className="btn glyphicon glyphicon-console" onClick={() => this.props.addTextArea(this.props.dataId, 'richContent')} title="Add rich content snippet"></button>;
