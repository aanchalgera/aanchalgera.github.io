...
class MoreOptions extends React.Component {
  render() {
    const twoColumnButton = <button type="button" className="btn" onClick={this.props.groupSections.bind(this, this.props.dataId, 2)} title="2 Columns"> 2 Columns</button>;
    const threeColumnButton = <button type="button" className="btn" onClick={this.props.groupSections.bind(this, this.props.dataId, 3)} title="3 Columns"> 3 Columns</button>;
