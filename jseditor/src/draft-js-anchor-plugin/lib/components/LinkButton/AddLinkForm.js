  ...
  function AddLinkForm() {
    ...
    return (
      (_ret = ((_temp = ((_this = _possibleConstructorReturn(
        this,
        (_ref =
          AddLinkForm.__proto__ ||
          Object.getPrototypeOf(AddLinkForm)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
      ...
      (_this.onChange = function(_ref2) {
        ...
        if (
          _this.state.isInvalid &&
          _URLUtils2.default.isUrl(_URLUtils2.default.normalizeUrl(value))
        ) {
  ...
  _createClass(AddLinkForm, [
    ...
    },
    {
      ...
      value: function submit() {
        ...
        if (!_URLUtils2.default.isUrl(url)) {
          ...
          setEditorState(
            _EditorUtils2.default.createLinkAtSelection(getEditorState(), url)
          );
          this.input.blur();
          this.onClose();
        }
    ...
    },
    {
      ...
      value: function render() {
        ...
        var className = isInvalid
          ? (0, _unionClassNames2.default)(theme.input, theme.inputInvalid)
          : theme.input;
