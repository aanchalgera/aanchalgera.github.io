  ...
  function LinkButton() {
    ...
    return (
      (_ret = ((_temp = ((_this = _possibleConstructorReturn(
        this,
        (_ref =
          LinkButton.__proto__ || Object.getPrototypeOf(LinkButton)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
      ...
      (_this.onAddLinkClick = function(e) {
        ...
        var content = function content(props) {
          return _react2.default.createElement(
            _AddLinkForm2.default,
            _extends({}, props, { placeholder: placeholder, theme: ownTheme })
          );
        };
  ...
  _createClass(LinkButton, [
    {
      ...
      value: function render() {
        ...
        var hasLinkSelected = _EditorUtils2.default.hasEntity(
          this.props.store.getEditorState(),
          'LINK'
        );
        var className = hasLinkSelected
          ? (0, _unionClassNames2.default)(theme.button, theme.active)
          : theme.button;
