...
var _decorateComponentWithProps2 = _interopRequireDefault(
  _decorateComponentWithProps
);
...
exports.default = function() {
  ...
  return {
    ...
    decorators: [
      {
        ...
        component:
          Link ||
          (0, _decorateComponentWithProps2.default)(_Link2.default, {
    ...
    LinkButton: (0, _decorateComponentWithProps2.default)(
      _LinkButton2.default,
      {
        ...
        onRemoveLinkAtSelection: function onRemoveLinkAtSelection() {
          return store.setEditorState(
            _EditorUtils2.default.removeLinkAtSelection(store.getEditorState())
          );
        }
      }
    )
