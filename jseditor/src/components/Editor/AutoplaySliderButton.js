...
class AutoplaySlideButton extends React.Component {
  toggleAutoplaySlider(event) {
    ...
    var autoplay =
      event.currentTarget.dataset.autoplay == 'false' ? true : false;
        ...
        <ul className="list-background">
          <li>
            <button
              ...
              data-autoplay={
                this.props.autoplay != undefined ? this.props.autoplay : false
              }
              onClick={this.toggleAutoplaySlider.bind(this)}
            >
              Autoplay
            </button>
          </li>
