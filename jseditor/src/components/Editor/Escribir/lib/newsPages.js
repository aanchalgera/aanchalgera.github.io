    ...
    <Row className="m-no-margin">
      <Col sm={6} smOffset={3}>
        ...
        <p className="paragraph">
          En Alfa la principal novedad es que nos quitamos de en medio el código
          visible. A partir de ahora el formato que des a los textos e imágenes
          se aplicará directamente sobre ellos.
        </p>
        <p className="paragraph">
          No obstante, no es una preview 100% real, para eso times el {'"ojo"'}{' '}
        ...
        <ul>
          ...
          <li>
            - Para dar formato al texto que acabas de escribir, resáltalo y las
            opciones aparecerán en pantalla.
          </li>
