...
class PostTitle extends React.Component {
  ...
  render() {
    var foregroundColor =
      this.props.data.foregroundColor == '#FFF'
        ? 'module-fg-light'
        : 'module-fg-dark';
    var backgroundFullscreen = this.props.data.backgroundFullscreen
        ...
        <div className="main-title" data-id="0">
          ...
          <div className={'asset-size-' + this.props.data.layout}>
            <div className="col-sm-12 marbot50">
              <div
                className={
                  this.props.data.backgroundClass + ' ' + foregroundColor
                }
                style={backgroundImageStyle}
              >
                <div
                  className={
                    this.props.data.backgroundFade == true
                      ? 'module-bg-fade '
                      : ''
                  }
                >
