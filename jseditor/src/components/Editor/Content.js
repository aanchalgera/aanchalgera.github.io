...
class Content extends React.Component {
  ...
  componentDidMount() {
    switch (this.props.data.type) {
      ...
      case 'summary':
        document
          .querySelector('#div-' + this.props.index + ' .blockquote')
          .setAttribute('style', this.props.getStyleText(this.props.data));
        break;
    }
  ...
  render() {
    ...
    if ('content' == this.props.data.type) {
      ...
      'infogram' == this.props.data.type ||
      'datawrapper' == this.props.data.type
    ) {
      field = (
        <Chart
          data={this.props.data}
    ...
    var backgroundClass = this.props.data.backgroundClass
    ...
    return (
      <div
        className={
          ...
          backgroundClass +
          ' ' +
          (this.props.data.backgroundFullscreen
            ? 'fullscreen-background'
            : '') +
          ' ' +
          (this.props.data.actualizacion ? 'actualizacion' : '')
        }
