...
class MoveControls extends React.Component {
  render() {
    ...
    var maximize = <button onClick={this.props.toggleMaximize.bind(this)} type="button" className="btn btn-info btn-sm glyphicon glyphicon-plus" title="Expand" />;
    var minimize = <button onClick={this.props.toggleMaximize.bind(this)} className="btn btn-info btn-sm glyphicon glyphicon-minus" type="button" title="Collapse" />;
    return (
