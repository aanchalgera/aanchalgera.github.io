      ...
      var deleteButton =
        totalImages == 1
          ...
          : <button
              ...
              onClick={e =>
                this.deleteImage(
                  { sectionIndex: this.props.dataId, imageIndex: i },
                  e
                )}
            >
              <span
        ...
        <button
          ...
          onClick={e =>
            this.openResourcePanel(
              'edit',
              { currentIndex: this.props.dataId, mode: 'edit', imageIndex: i },
              'gallery',
              true,
              e
            )}
        >
          <span className="glyphicon glyphicon-pencil" title="Edit Image" />
        </button>
      );
      return (
